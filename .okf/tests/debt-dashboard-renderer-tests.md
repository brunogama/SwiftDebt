...
resource: Tests/SwiftDebtKitTests/DebtDashboardRendererTests.swift
...
`DebtDashboardRendererTests` renders the canonical debt-report fixture through both JSON data and decoded `DebtReport` entry points. The output must match the canonical `canonical-debt-dashboard.golden.html` fixture and contain the SwiftDebt debt dashboard marker and native debt-report kind.
...
[1] [DebtDashboardRendererTests.swift](../../Tests/SwiftDebtKitTests/DebtDashboardRendererTests.swift)
[2] [canonical-debt-dashboard.golden.html](../../Tests/SwiftDebtKitTests/Fixtures/DebtReport/canonical-debt-dashboard.golden.html)
[3] [canonical-debt-report.golden.json](../../Tests/SwiftDebtKitTests/Fixtures/DebtReport/canonical-debt-report.golden.json)
