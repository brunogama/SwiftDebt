...
description: SwiftDebt records opt-in phase profiling output and evaluates comparable benchmark results against wall-clock and peak-memory regression budgets.
resource: Sources/SwiftDebtKit/AnalysisProfiler.swift
...
`benchmarks/debtmap-baseline/methodology.v2.json` includes phase-wall-clock nanosecond measurement, profile-output arguments for measured commands, noise controls, required platform metadata, disallowed cross-workload comparisons, exception evidence, and two SwiftDebt workload budgets: `baseline-analysis` and `full-evidence-analysis`.

# Citations

[1] [AnalysisProfiling.swift](../../Sources/SwiftDebtCore/AnalysisProfiling.swift)
[2] [PerformanceBudgetGate.swift](../../Sources/SwiftDebtCore/PerformanceBudgetGate.swift)
[3] [AnalysisProfiler.swift](../../Sources/SwiftDebtKit/AnalysisProfiler.swift)
...
[7] [DebtCLIOptions.swift](../../Sources/swift-debt/DebtCLIOptions.swift)
[8] [methodology.v2.json](../../benchmarks/debtmap-baseline/methodology.v2.json)
