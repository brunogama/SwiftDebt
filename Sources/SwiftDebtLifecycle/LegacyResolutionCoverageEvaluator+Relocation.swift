...
struct LegacyResolutionRelocationAssessment {
...
extension LegacyResolutionCoverageEvaluator {
    func assessRelocation(
        finding: Finding,
        snapshot: ObservationSnapshot,
        artifact: LifecycleArtifact
    ) throws -> LegacyResolutionRelocationAssessment {
        ...
        guard !snapshot.provenance.scope.isCompleteRepository else {
            guard !trace.reasons.isEmpty else {
                return LegacyResolutionRelocationAssessment(blockers: [], proofReasons: [])
            }
            return LegacyResolutionRelocationAssessment(
                blockers: [],
        ...
        return LegacyResolutionRelocationAssessment(blockers: blockers, proofReasons: [])
    }
