...
public struct DebtReport: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        reportKind: String = "swiftdebt-report",
...
///
/// This type is not the native SwiftDebt debt-report model. It preserves the
...
public struct DebtmapCompatibilityProjection: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        projectionNote: String =
            "Deterministic SwiftDebt projection for Debtmap-oriented automation; not the native SwiftDebt debt model.",
