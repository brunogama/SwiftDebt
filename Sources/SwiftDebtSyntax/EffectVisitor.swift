...
final class EffectVisitor: SyntaxVisitor {
    ...
    func recordInoutParameter(name: String, location: SwiftDebtCore.SourceLocation) {
        effectFacts.append(
            SyntaxEffectFact(
    ...
    private func recordAssignment(target: String, operatorText: String, location: SwiftDebtCore.SourceLocation) {
