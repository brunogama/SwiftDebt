...
extension ReportRenderer {
    ...
    package func renderDebtDashboard(_ report: DebtReport) throws -> String {
        ...
        guard report.reportKind == "swiftdebt-report" else {
