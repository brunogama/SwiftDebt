...
SwiftSCMA is an independent implementation, not the authors' original tool and not an affiliated product. The original paper, original tool source, and Lizard code are not redistributed here. The native clone engine does not claim Lizard equivalence.
