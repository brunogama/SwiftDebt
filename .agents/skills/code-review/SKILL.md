...
1. Local ticket references in the branch name or commit messages (a short identifier such as `12g` or `04a` matching `.scratch/tickets/<id>.md`) — read `.scratch/tickets/<id>.md` via the workflow in `docs/agents/issue-tracker.md`.
